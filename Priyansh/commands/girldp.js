...
"https://i.imgur.com/PqD8g7j.jpeg",
  ...
  var callback = () => api.sendMessage({ body: `👉❤️𝐌𝐚𝐝𝐞 𝐛𝐲 ཫ༄𒁍𝐉𝐀𝐌𝐀𝐋💙✨️`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg") }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));
